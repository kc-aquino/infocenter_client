    ...
    advisories: [
      {
        ...
        advisoryDescription:
          'A tsunami has been detected. Move immediately to higher ground or inland areas.',
      ...
      },
      {
        ...
        advisoryDescription:
          'A tsunami is possible. Stay tuned for updates and be prepared to evacuate if necessary.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'A tsunami is expected to affect the area. Stay away from coastal areas and do not attempt to watch the tsunami from close proximity.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'A tsunami is expected to cause widespread flooding in coastal areas. Evacuate immediately.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'The tsunami has passed. Follow local authorities for cleanup and recovery guidelines.',
