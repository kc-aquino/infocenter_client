...
const PharmacyPage = () => {
  const pharmacies = {
    'pharmacy-1': {
      ...
      position: [14.694388970482928, 120.9325052605846] as [number, number],
      image: pharmacy1img,
      address:
      ...
      location_link: 'https://maps.app.goo.gl/mJ6P7phvZkwR36Zn9',
    },
    'pharmacy-2': {
      name: 'Cabino Drugstore',
      position: [14.695339171427221, 120.9322053696048] as [number, number],
      image: pharmacy2img,
      address: '20 Dona Juana Rodriguez-1, Manila, Metro Manila',
      description:
        'The maximum temperature today is near 86 degrees. A partly cloudy and warm day is expected. The lowest relative humidity is near 33 percent. Expect 13 hours of sunshine...',
      location_link: 'https://maps.app.goo.gl/Pnc3cstQuRtoXJkLA',
    },
  };
