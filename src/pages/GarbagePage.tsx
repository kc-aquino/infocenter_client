    ...
    advisories: [
      {
        ...
        advisoryDescription:
          'Garbage collection has been delayed due to inclement weather. Please keep your trash containers secure.',
      ...
      },
      {
        ...
        advisoryDescription:
          'Remember to recycle paper, plastic, glass and metal. Reduce waste and help the environment.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'Bulky items will be collected on the next scheduled pickup. Please place them at the curb by 6am.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'Composting is an easy way to reduce waste and create nutrient-rich soil. Learn how to compost at home.',
        advisoryStatus: 'Active',
      ...
      },
      {
        ...
        advisoryDescription:
          'Garbage collection will resume its regular schedule starting next week. Check the city website for details.',
