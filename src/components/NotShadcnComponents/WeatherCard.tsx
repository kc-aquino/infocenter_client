...
const WeatherCard: React.FC<WeatherCardProps> = ({ weatherData, day }) => {
  ...
  return (
    <div className={`flex flex-col gap-5 p-2 items-center justify-center rounded-xl bg-[#FF6F00] text-[#FF6F00] ${isToday ? 'w-full h-80' : 'h-64 w-32'}`}>
      ...
      <div className='bg-white w-full rounded-md p-2 flex flex-col justify-center pt-7 gap-4'>
        <div className={`w-full flex justify-center font-bold'${isToday ? 'text-3xl' : 'text-sm'}`}>
